    ...
    var $window = $(window);
        ...
        $window.on('scroll', function() {
            ...
            if (scroll <= 50) {
                ...
                logoinner.attr('src', '../static/img/logos/logo.png');
                logodefault.attr('src', '../static/img/logos/logo_1.png');

            }
            else {
                $("header").removeClass("fixedHeader").addClass("scrollHeader");
                 logoinner.attr('src', '../static/img/logos/logo_1.png');
                logodefault.attr('src', '../static/img/logos/logo.png');
...
var buttons = "<button class=\"slidebtn prev\"><i class=\"fa fa-angle-left\"></i></button><button class=\"slidebtn next\"><i class=\"fa fa-angle-right\"></i></button\>";

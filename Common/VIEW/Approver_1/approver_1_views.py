    ...
    if 'approves_1_login_type' in request.session:
        ...
        if request.method == 'POST':
            ...
            if company['success'] == 1:
                ...
                return render(request,"Company/Approver_1/visa_requests.html",{'visa_services':corporates_data})
            else:
                return render(request,"Company/Approver_1/visa_requests.html",{'visa_services':{}})
    else:
        return HttpResponseRedirect("/login")
...
def view_visa_requests(request, id):
    if 'approves_1_login_type' in request.session:
        ...
        if request.method == 'POST':
            ...
            return render(request, "Company/Approver_1/view_visa_request.html", {'visas':visas,'countrys': Country, 'states': states, 'cities': cities, 'employees': employees})
...
def accept_visa_booking(request):
    ...
    if 'approves_1_login_type' in request.session:
        ...
        url = settings.API_BASE_URL + "approver_1_accept_visa_booking"
        payload = {'booking_id': booking_id,'user_id':user_id,'user_comment':user_comment}
        print(payload)
        company = getDataFromAPI(login_type, access_token, url, payload)
...
def reject_visa_booking(request):
    ...
    if 'approves_1_login_type' in request.session:
        ...
        url = settings.API_BASE_URL + "approver_1_reject_visa_booking"
        payload = {'booking_id': booking_id,'user_id':user_id,'user_comment':user_comment}
        company = getDataFromAPI(login_type, access_token, url, payload)
    ...
    if 'approves_1_login_type' in request.session:
        ...
        if request.method == 'POST':
            ...
            if company['success'] == 1:
                ...
                return render(request, "Company/Approver_1/frro_services.html", {'visa_services': corporates_data, 'booking_type': id})
            else:
                return render(request, "Company/Approver_1/frro_services.html", {'visa_services': {}})
    else:
        return HttpResponseRedirect("/login")
    ...
    if 'approves_1_login_type' in request.session:
        ...
        if request.method == 'POST':
            ...
            if taxies11sad['success'] == 1:
                ...
                return render(request,"Company/Approver_1/view_frro_request.html",{'visas':visas})
            else:
                return render(request,"Company/Approver_1/view_frro_request.html",{'visas':{}})
    else:
        return HttpResponseRedirect("/login")
...
def accept_frro_booking(request):
    ...
    if 'approves_1_login_type' in request.session:
        ...
        url = settings.API_BASE_URL + "approver_1_accept_frro_booking"
        payload = {'booking_id': booking_id,'user_id':user_id,'user_comment':user_comment}
        print(payload)
        company = getDataFromAPI(login_type, access_token, url, payload)
...
def reject_frro_booking(request):
    ...
    if 'approves_1_login_type' in request.session:
        ...
        url = settings.API_BASE_URL + "approver_1_reject_frro_booking"
        payload = {'booking_id': booking_id,'user_id':user_id,'user_comment':user_comment}
        company = getDataFromAPI(login_type, access_token, url, payload)
...
def view_employee_frro_details(request, id):
    if 'approves_1_login_type' in request.session:
        ...
        return render(request, "Company/Approver_1/view_employee_document_details.html", {'employees': companies, 'documents':companies1})
...
def guesthouse_bookings(request, id):
    if 'approves_1_login_type' in request.session:
        ...
        if company['success'] == 1:
            booking = company['Bookings']
            return render(request, "Company/Approver_1/guesthouse_bookings.html",{'bookings': booking, 'booking_type': id})
        else:
...
def view_guesthouse_booking(request, id):
    if 'approves_1_login_type' in request.session:
        ...
        if company['success'] == 1:
            booking = company['Bookings']
            return render(request, "Company/Approver_1/view_guesthouse_booking.html", {'bookings': booking})
        else:
            return render(request, "Company/Approver_1/view_guesthouse_booking.html", {'': {}})
    else:
        return HttpResponseRedirect("/login")
...
def accept_guesthouse_booking(request,id):
    ...
    if 'approves_1_login_type' in request.session:
        ...
        url = settings.API_BASE_URL + "approver_1_accept_guesthouse_booking"
        payload = {'booking_id': booking_id,'user_id':user_id,'user_comment':user_comment}
        print(payload)
        company = getDataFromAPI(login_type, access_token, url, payload)
...
def reject_guesthouse_booking(request,id):
    ...
    if 'approves_1_login_type' in request.session:
        ...
        url = settings.API_BASE_URL + "approver_1_reject_guesthouse_booking"
        payload = {'booking_id': booking_id,'user_id':user_id,'user_comment':user_comment}
        company = getDataFromAPI(login_type, access_token, url, payload)

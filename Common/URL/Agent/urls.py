...
urlpatterns = [
    ...
    path('agents/cotrav-corporate-public-api', agent_views.cotrav_corporate_public_api),
    ...
    path('agents/visa-billing/verify', agent_views.visa_billing_verify, name='agent-visa-billing-verify'),
    path('agents/frro-billing/verify', agent_views.frro_billing_verify, name='agent-frro-billing-verify'),
    ...
    path('agents/view-visa-request/<int:id>', agent_views.view_visa_request),
    path('agents/visa-service-provided', agent_views.visa_service_provided),
    path('agents/delete-visa-document', agent_views.delete_visa_document),
    path('agents/add-new-employee-document', agent_views.add_new_employee_document),
    path('agents/accept-visa-request', agent_views.accept_visa_request),
    path('agents/assign-visa-request/<int:id>', agent_views.assign_visa_booking),
    path('agents/cotrav-visa-invoice/<int:id>', agent_views.visa_requests_invoices),
    path('agents/add-visa-status', agent_views.add_visa_status),
    path('agents/consulate-office', agent_views.consulate_office),

    path('agents/add-booking-feedback', agent_views.add_booking_feedback),

    path('agents/taxi-vendor-billing/<int:id>', agent_views.taxi_vendor_billing),
    path('agents/taxi-vendor-billing/verify', agent_views.taxi_vendor_billing_verify),
    path('agents/bus-vendor-billing/<int:id>', agent_views.bus_vendor_billing),
    path('agents/bus-vendor-billing/verify', agent_views.bus_vendor_billing_verify,),
    path('agents/flight-vendor-billing/<int:id>', agent_views.flight_vendor_billing),
    path('agents/flight-vendor-billing/verify', agent_views.flight_vendor_billing_verify),
    path('agents/hotel-vendor-billing/<int:id>', agent_views.hotel_vendor_billing),
    path('agents/hotel-vendor-billing/verify', agent_views.hotel_vendor_billing_verify),
    path('agents/operator-accounts', agent_views.operator_accounts),
    path('agents/add-operator-accounts/<int:id>', agent_views.add_operator_accounts),
    path('agents/operator-podetails', agent_views.operator_podetails),
    path('agents/add-operator-podetail/<int:id>', agent_views.add_operator_podetail),
    path('agents/operator-bill-create', agent_views.operator_bill_create),
    path('agents/operator-bill-create-nontax-invoice', agent_views.operator_bill_create_nontax_invoice),
    path('agents/operator-bill-nontax-invoice/<int:id>', agent_views.get_all_generated_operator_bills),
    path('agents/operator-bill-tax-invoice/<int:id>', agent_views.get_all_operator_bill_payment_status),
    path('agents/accept-operator-bill', agent_views.accept_operator_bill),
    path('agents/pay-operator-bill', agent_views.pay_operator_bill),
    path('agents/generate-final-operator-bill', agent_views.generate_final_operator_bill),
    path('agents/edit-operator-bill-detail/<int:id>', agent_views.edit_operator_bill_detail),
    path('agents/add-taxi-vendor-invoice/<int:id>', agent_views.add_taxi_vendor_invoice),

    path('agents/frro-requests/<int:id>', agent_views.get_all_frro_requests),
    path('agents/add-new-frro-request', agent_views.add_new_frro_request),
    path('agents/view-frro-request/<int:id>', agent_views.view_frro_request),
    path('agents/accept-frro-request', agent_views.accept_frro_request),
    path('agents/add-frro-status', agent_views.add_frro_status),
    path('agents/frro-rules-display', agent_views.frro_rules_display),
    path('agents/frro-change-document', agent_views.frro_change_document),

    path('agents/change-frro-booking-document-letter', agent_views.change_frro_document_letter),
    path('agents/change-frro-booking-office-status', agent_views.change_frro_office_status),
    path('agents/change-frro-booking-issue', agent_views.change_frro_issue_document),
    path('agents/add-frro-booking-pending-document', agent_views.add_frro_pending_document),
    path('agents/add-frro-booking-request-letter', agent_views.add_frro_request_letter),
    path('agents/add-frro-booking-status', agent_views.add_frro_request_status),
    path('agents/view-employee-frro-details/<int:id>', agent_views.view_employee_frro_details),

    path('agents/cotrav-frro-invoice/<int:id>', agent_views.frro_requests_invoices),

    path('agents/add-frro-booking-invoice', agent_views.add_frro_booking_invoice),

    path('agents/guesthouse-bookings/<int:id>', agent_views.guesthouse_bookings),
    path('agents/view-guesthouse-booking/<int:id>', agent_views.view_guesthouse_booking),
    path('agents/view-guesthouse-details/<int:id>', agent_views.view_guesthouse_details),
    path('agents/download-guesthouse-bookings', agent_views.download_guesthouse_bookings),
    path('agents/guesthouse-billing/<int:id>', agent_views.guesthouse_billing),

    path('agents/add-guesthouse-invoice/<int:id>', agent_views.add_guesthouse_invoice),
    path('agents/guesthouse-billing/verify', agent_views.guesthouse_billing_verify),
    path('agents/all-guesthouse/<int:id>', agent_views.all_guesthouses),
    path('agents/add-guesthouse', agent_views.add_guesthouses),
    path('agents/add-guesthouse-amenities', agent_views.add_guesthouses_amenities),
    path('agents/add-guesthouse-rooms', agent_views.add_guesthouses_rooms),
    path('agents/get-guesthouse-rooms/<int:id>', agent_views.get_guesthouses_rooms),
    path('agents/all-guesthouse-roomtype/<int:id>', agent_views.get_guesthouses_roomtype),
    path('agents/add-guesthouse-room-types/<int:id>', agent_views.add_guesthouses_room_types),
    path('agents/delete-guesthouse/<int:id>', agent_views.delete_guesthouse),
    path('agents/delete-guesthouse-room/<int:id>', agent_views.delete_guesthouseroom),
    path('agents/delete-guesthouse-roomtype/<int:id>', agent_views.delete_guesthouseroomtype),

    path('agents/screenshot-flight-booking', agent_views.screenshot_flight_booking),
]
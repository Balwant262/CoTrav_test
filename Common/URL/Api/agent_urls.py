...
urlpatterns = [
    ...
    path('api/agent_verify_visa_bookings', agent_api_view.agent_verify_visa_bookings),
    path('api/agent_revise_visa_bookings', agent_api_view.agent_revise_visa_bookings),
    path('api/agent_verify_frro_bookings', agent_api_view.agent_verify_frro_bookings),
    path('api/agent_revise_frro_bookings', agent_api_view.agent_revise_frro_bookings),
    ...
    path('api/agent_update_visa_bookings', agent_api_view.agent_update_visa_bookings),
    path('api/agent_update_frro_bookings', agent_api_view.agent_update_frro_bookings),
    ...
    path('api/visa_service_provided_cotrav', agent_api_view.visa_service_provided_cotrav),
    path('api/add_visa_service_provided_cotrav', agent_api_view.add_visa_service_provided_cotrav),
    path('api/update_visa_service_provided_cotrav', agent_api_view.update_visa_service_provided_cotrav),
    path('api/accept_visa_request', agent_api_view.accept_visa_request),
    path('api/request_visa_request', agent_api_view.request_visa_request),
    path('api/assign_visa_request', agent_api_view.assign_visa_request),

    path('api/add_new_visa_status', agent_api_view.add_new_visa_status),

    path('api/get_all_operator_bills', agent_api_view.get_all_operator_bills),
    path('api/operator_bill_create_nontax_invoice', agent_api_view.operator_bill_create_nontax_invoice),
    path('api/get_all_generated_operator_bills', agent_api_view.get_all_generated_operator_bills),
    path('api/get_all_operator_bill_payment_status', agent_api_view.get_all_operator_bill_payment_status),
    path('api/pay_operator_bill', agent_api_view.pay_operator_bill),
    path('api/get_operator_accounts', agent_api_view.get_operator_accounts),
    path('api/add_operator_account', agent_api_view.add_operator_account),
    path('api/update_operator_account', agent_api_view.update_operator_account),
    path('api/delete_operator_account', agent_api_view.delete_operator_account),
    path('api/get_operator_podetails', agent_api_view.get_operator_podetails),
    path('api/add_operator_podetails', agent_api_view.add_operator_podetails),
    path('api/update_operator_podetails', agent_api_view.update_operator_podetails),
    path('api/delete_operator_podetails', agent_api_view.delete_operator_podetails),
    path('api/accept-operator-bill', agent_api_view.accept_operator_bill),
    path('api/reject-operator-bill', agent_api_view.reject_operator_bill),
    path('api/view-operator-bill', agent_api_view.view_operator_bill),
    path('api/update-operator-bill', agent_api_view.update_operator_bill),
    path('api/add_taxi_vendor_invoice', agent_api_view.add_taxi_vendor_invoice),
    path('api/agent_verify_vendor_bookings', agent_api_view.agent_verify_vendor_bookings),
    path('api/agent_revise_vendor_bookings', agent_api_view.agent_revise_vendor_bookings),
    path('api/agent_update_vendor_bookings', agent_api_view.agent_update_vendor_bookings),
    path('api/operator_bill_create_final_invoice', agent_api_view.operator_bill_create_final_invoice),

    path('api/agent_frro_request', agent_api_view.get_frro_request),
    path('api/accept_frro_request', agent_api_view.accept_frro_request),
    path('api/reject_frro_request', agent_api_view.reject_frro_request),

    path('api/get_frro_request_type', agent_api_view.get_frro_request_type),
    path('api/get_frro_document_list_by_request_type', agent_api_view.get_frro_document_list_by_request_type),
    path('api/get_rules_to_display', agent_api_view.get_rules_to_display),
    path('api/add_new_frro_status', agent_api_view.add_new_frro_status),
    path('api/get_frro_status_by_request_type', agent_api_view.get_frro_status_by_request_type),
    path('api/get_employee_questionnaire_details', agent_api_view.get_employee_questionnaire_details),

    path('api/change_frro_document_letter', agent_api_view.change_frro_document_letter),
    path('api/change_frro_office_status', agent_api_view.change_frro_office_status),
    path('api/change_frro_issue_document', agent_api_view.change_frro_issue_document),
    path('api/add_frro_pending_document', agent_api_view.add_frro_pending_document),
    path('api/add_frro_request_letter', agent_api_view.add_frro_request_letter),

    path('api/get_frro_fees_by_corporate_id', agent_api_view.get_frro_fees_by_corporate_id),
    path('api/add_frro_booking_invoice', agent_api_view.add_frro_booking_invoice),
    path('api/agent_frro_request_invoice', agent_api_view.agent_frro_request_invoice),

    path('api/add_guesthouse_invoice', agent_api_view.add_guesthouse_invoice),
    path('api/agent_verify_guesthouse_bookings', agent_api_view.agent_verify_guesthouse_bookings),
    path('api/agent_revise_guesthouse_bookings', agent_api_view.agent_revise_guesthouse_bookings),
    path('api/agent_update_guesthouse_bookings', agent_api_view.agent_update_guesthouse_bookings),
